...
class MiddleOutGUI:
    ...
    def setup_ui(self):
        ...
        try:
            ...
            banner_img = Image.open(banner_path).resize((560, 120))
            self.banner_tk = ImageTk.PhotoImage(banner_img)
            tk.Label(self.root, image=self.banner_tk, bg="#1e1e1e").pack(pady=(10, 0))
        except Exception as e:
    ...
    def start_compression(self):
        ...
        self.progress.start(100)  # slower progress animation
